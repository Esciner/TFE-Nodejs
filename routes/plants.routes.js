...
const { plantsList, plantNew, plantCreate, plantDelete, plantEdit, plantUpdate, plantAnalyse } = require('../controllers/plants.controller');

//GET
router.get('/edit/:plantId', plantEdit);
router.get('/analyser', plantAnalyse);
